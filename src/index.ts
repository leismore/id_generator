...
import * as serid             from './serid/index';
...
// 6. SERID (Shorter ID)
const        SERID_URL = CONFIG.api.baseURL + CONFIG.api.shorter.url;
app.use(     SERID_URL, serid.cors_handler );
app.all(     SERID_URL, serid.all_handler1 );
app.head(    SERID_URL, head_handler );
app.get(     SERID_URL, serid.get_handler1, serid.get_handler2 );
